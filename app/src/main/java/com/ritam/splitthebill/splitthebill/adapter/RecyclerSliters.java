...
/**
 * Created by su on 24/4/17.
 */

public class RecyclerSliters extends RecyclerView.Adapter<RecyclerSliters.ViewHolder> {

    BookingAsHost inastance;

    public RecyclerSliters(BookingAsHost bookingAsHost) {
        inastance=bookingAsHost;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.spliters_layout,parent,false);
